...
class UnstructuredSearchVisualization : IVisualization<UNSTRUCTUREDSEARCH, API_QUANTUMCIRCUIT> {
    ...
    public API_QUANTUMCIRCUIT visualize(UNSTRUCTUREDSEARCH instance) {
