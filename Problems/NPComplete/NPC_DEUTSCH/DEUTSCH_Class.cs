...
class DEUTSCH : IProblem<DeutschClassicalSolver, DeutschClassicalVerifier, DummyVisualization> {
    ...
    public string inputDescription { get; } = "f, a function {0,1} -> {0,1} promised to be constant or balanced, given as (f(0), f(1))";
    ...
    public string[] contributors { get; } = { "Eric Hill", "Paul Gilbreath", "Max Grünwoldt", "Alex Svancara", "Jason L. Wright", "Michael Trosper" };
