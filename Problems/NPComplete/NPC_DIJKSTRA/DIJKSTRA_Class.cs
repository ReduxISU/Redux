...
class DIJKSTRA : IGraphProblem<DijkstraBruteForce, DijkstraVerifier, DijkstraDefaultVisualization, UtilCollectionGraph>
{
    ...
    public string problemDefinition { get; } = "Dijkstra’s Shortest Path Problem is the problem of determining the shortest path distances from a given source vertex to all other vertices in a weighted graph with nonnegative edge weights.";
    ...
    public string[] contributors { get; } = { "Tiger Sant", "Malaya Witt" };
