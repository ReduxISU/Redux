...
class SimonVerifier : IVerifier<SIMON> {
    ...
    // --- Fields ---
    public string verifierName { get; } = "Default Simon's Problem Verifier";
    ...
    public string[] contributors { get; } = { "Jason L. Wright", "Eric Hill", "Paul Gilbreath", "Max Grünwoldt", "Alex Svancara" };
