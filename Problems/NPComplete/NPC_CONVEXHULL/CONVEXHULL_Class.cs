...
class CONVEXHULL : IProblem<ConvexHullSolver, ConvexHullVerifier, ConvexHullVisualization> {
    ...
    public string instanceFormat { get; } = "Brace-wrapped, comma-separated set of 2D points (x,y) with real-valued coordinates. Example: {(-0.49429993857731547,-0.14539088193288174),(0.7674622377407927,-0.21537444528240846),(-0.9308276577586132,-0.1423800479224624),(-0.6984449872706371,0.3857380723376367),(-0.27394905790800017,-0.7488048223660126),(0.6681904385614421,-0.11341930745315643),(0.6077591838324792,0.5288040272918157),(0.32371432910023556,0.12231914413229394),(-0.32705115386597394,0.6744065707101621),(0.2723211656942368,-0.8053758131859647)}";
    public string certificateFormat { get; } = "Parenthesized, comma-separated ordered list of (x,y) points forming the convex hull's vertices in order. Example: ((0.2723211656942368,-0.8053758131859647), (0.7674622377407927,-0.21537444528240846), (0.6077591838324792,0.5288040272918157), (-0.32705115386597394,0.6744065707101621), (-0.6984449872706371,0.3857380723376367), (-0.9308276577586132,-0.1423800479224624), (-0.27394905790800017,-0.7488048223660126))";
