...
namespace API.Problems.NPHard.NPH_MINIMUMVERTEXCOVER.Verifiers;

class MinimumVertexCoverVerifier : IVerifier<MINIMUMVERTEXCOVER> {
    ...
    public MinimumVertexCoverVerifier() {

    }

    /// <summary>
    /// This Method Verifies whether a passed in Minimum Vertex Cover (problem) is covered by the set of nodes (c). 
    /// </summary>
    /// <param name="problem"></param>
    /// <param name="certificate"></param>
    /// <returns></returns>
    public bool verify(MINIMUMVERTEXCOVER problem, string certificate) {
